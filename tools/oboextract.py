...
def argparser():
    ...
    ap.add_argument(
        ...
        default=False,
        action="store_true",
        help="Exclude subtrees involving multiple inheritance.")
    ap.add_argument(
        "-ns",
        "--no-synonyms",
        default=False,
        action="store_true",
        help="Do not extract synonyms.")
    ap.add_argument(
        "-nd",
        "--no-definitions",
        default=False,
        action="store_true",
        help="Do not extract definitions.")
    ap.add_argument(
        "-e",
        "--exclude",
        default=[],
        metavar="TERM",
        nargs="+",
        help="Exclude subtrees rooted at given TERMs.")
    ap.add_argument(
        "-s",
        "--separate-children",
        default=False,
    ...
    ap.add_argument(
        ...
        metavar="TERM",
        nargs="*",
        help="Root terms from which to extract.")
    return ap
...
def main(argv=None):
    ...
    if not arg.separate_parents:
        ...
        if len(rootterms) == 0:
            ...
            print("Extracting from %d root terms." % len(
                rootterms), file=sys.stderr)
